...
void updatePWM ( )
{
#if     LIGHT_TYPE == LIGHT_TYPE_MARINE_REEF_500 || LIGHT_TYPE == LIGHT_TYPE_MARINE_REEF_800 || LIGHT_TYPE == LIGHT_TYPE_MARINE_REEF_1100
    PWM2_LoadDutyValue(gLedRunPara.nCurrentBrt[0]);
    PWM4_LoadDutyValue(gLedRunPara.nCurrentBrt[1]);
    PWM5_LoadDutyValue(gLedRunPara.nCurrentBrt[2]);
    PWM3_LoadDutyValue(gLedRunPara.nCurrentBrt[3]);
    PWM1_LoadDutyValue(gLedRunPara.nCurrentBrt[4]);
#elif   LIGHT_TYPE == LIGHT_TYPE_PLANT_FRESH_500 || LIGHT_TYPE == LIGHT_TYPE_PLANT_FRESH_800 || LIGHT_TYPE == LIGHT_TYPE_PLANT_FRESH_1100
    PWM2_LoadDutyValue( gLedRunPara.nCurrentBrt[0] );
    PWM5_LoadDutyValue( gLedRunPara.nCurrentBrt[1] );
    PWM3_LoadDutyValue( gLedRunPara.nCurrentBrt[2] );
    PWM1_LoadDutyValue( gLedRunPara.nCurrentBrt[3] );
    PWM4_LoadDutyValue( gLedRunPara.nCurrentBrt[4] );
#elif LIGHT_TYPE == LIGHT_TYPE_NANO_MARINE
    PWM2_LoadDutyValue(gLedRunPara.nCurrentBrt[0]);
    PWM1_LoadDutyValue(gLedRunPara.nCurrentBrt[1]);
    PWM3_LoadDutyValue(gLedRunPara.nCurrentBrt[2]);
    PWM4_LoadDutyValue(gLedRunPara.nCurrentBrt[3]);
    PWM5_LoadDutyValue(gLedRunPara.nCurrentBrt[4]);
    ...
    PWM1_LoadDutyValue( gLedRunPara.nCurrentBrt[2] );
    PWM5_LoadDutyValue( gLedRunPara.nCurrentBrt[3] );
    PWM4_LoadDutyValue( gLedRunPara.nCurrentBrt[4] );
#else
    PWM3_LoadDutyValue( gLedRunPara.nCurrentBrt[0] );
    PWM2_LoadDutyValue( gLedRunPara.nCurrentBrt[1] );
...
{
    //marine blue channel-2,	plant blue channel-1
    for ( unsigned char i = 0; i < CHANNEL_COUNT; i++ )
    {
